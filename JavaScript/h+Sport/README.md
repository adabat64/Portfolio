...
* Extra challenge from tutorial - added new store in Seattle with a State tax of 6.5% and a new product costing $4 per item. Added to both HTML, and current JS calculations.
